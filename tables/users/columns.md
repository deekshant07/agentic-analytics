...
## Signup Date★
- `signup_date` | high | The date and time when the user signed up. This column is never null.
...
## App Version
- `app_version` | medium | The version of the application used by the user. This column is never null.
...
## Acquisition Cohort
- `acquisition_cohort` | medium | The method through which the user was acquired. This column is never null.

## KYC Completed★
- `kyc_completed` | high | Indicates whether the user has completed the Know Your Customer process. This column is never null.

## Account Type
- `account_type` | medium | The type of account the user holds. This column is never null.
...
- `avg_txn_amount` | medium | The average amount of transactions made by the user. This column is never null.
